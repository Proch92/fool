...
public class SVMParser extends Parser {
	...
	public final AssemblyContext assembly() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PUSH) | (1L << POP) | (1L << ADD) | (1L << SUB) | (1L << MULT) | (1L << DIV) | (1L << STOREW) | (1L << LOADW) | (1L << BRANCH) | (1L << BRANCHEQ) | (1L << BRANCHLESS) | (1L << JS) | (1L << LOADRA) | (1L << STORERA) | (1L << LOADRV) | (1L << STORERV) | (1L << LOADFP) | (1L << STOREFP) | (1L << COPYFP) | (1L << LOADHP) | (1L << STOREHP) | (1L << PRINT) | (1L << HALT) | (1L << LABEL))) != 0)) {
				{
				setState(58);
				...
				case 1:
					...
					setState(3); ((AssemblyContext)_localctx).e = match(NUMBER);
					code[i++] = PUSH; 
								     code[i++] = Integer.parseInt((((AssemblyContext)_localctx).e!=null?((AssemblyContext)_localctx).e.getText():null));
					}
					break;
				...
				case 2:
					...
					setState(6); ((AssemblyContext)_localctx).e = match(LABEL);
					code[i++] = PUSH;
						    		     labels.add((((AssemblyContext)_localctx).e!=null?((AssemblyContext)_localctx).e.getText():null));
				...
				case 10:
					{
					setState(22); ((AssemblyContext)_localctx).e = match(LABEL);
					setState(23); match(COL);
					labelAddress.put((((AssemblyContext)_localctx).e!=null?((AssemblyContext)_localctx).e.getText():null),new Integer(i));
					}
					break;
				...
				case 11:
					...
					setState(26); ((AssemblyContext)_localctx).e = match(LABEL);
					code[i++] = BRANCH;
						  		     labels.add((((AssemblyContext)_localctx).e!=null?((AssemblyContext)_localctx).e.getText():null));
						  		     addresses.add(new Integer(i)); 
						  		     code[i++] = 0;
				...
				case 12:
					...
					setState(29); ((AssemblyContext)_localctx).e = match(LABEL);
					code[i++] = BRANCHEQ;
						  	  	     labels.add((((AssemblyContext)_localctx).e!=null?((AssemblyContext)_localctx).e.getText():null));
						  		     addresses.add(new Integer(i)); 
						  		     code[i++] = 0;
				...
				case 13:
					{
					setState(31); match(BRANCHLESS);
					setState(32); ((AssemblyContext)_localctx).e = match(LABEL);
					code[i++] = BRANCHLESS;
						  	  	     labels.add((((AssemblyContext)_localctx).e!=null?((AssemblyContext)_localctx).e.getText():null));
						  		     addresses.add(new Integer(i)); 
						  		     code[i++] = 0;
	...
	public static final String _serializedATN =
		"\3\uacf5\uee8c\u4f5d\u8b0d\u4a45\u78bd\u1b2f\u3378\3\36D\4\2\t\2\3\2\3"+
		"\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2"+
		"\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3"+
		"\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2\3\2"+
		"\3\2\3\2\7\2=\n\2\f\2\16\2@\13\2\3\2\3\2\3\2\2\3\2\2\2[\2>\3\2\2\2\4\5"+
		"\7\3\2\2\5\6\7\34\2\2\6=\b\2\1\2\7\b\7\3\2\2\b\t\7\33\2\2\t=\b\2\1\2\n"+
		"\13\7\4\2\2\13=\b\2\1\2\f\r\7\5\2\2\r=\b\2\1\2\16\17\7\6\2\2\17=\b\2\1"+
		"\2\20\21\7\7\2\2\21=\b\2\1\2\22\23\7\b\2\2\23=\b\2\1\2\24\25\7\t\2\2\25"+
		"=\b\2\1\2\26\27\7\n\2\2\27=\b\2\1\2\30\31\7\33\2\2\31\32\7\32\2\2\32="+
		"\b\2\1\2\33\34\7\13\2\2\34\35\7\33\2\2\35=\b\2\1\2\36\37\7\f\2\2\37 \7"+
		"\33\2\2 =\b\2\1\2!\"\7\r\2\2\"#\7\33\2\2#=\b\2\1\2$%\7\16\2\2%=\b\2\1"+
		"\2&\'\7\17\2\2\'=\b\2\1\2()\7\20\2\2)=\b\2\1\2*+\7\21\2\2+=\b\2\1\2,-"+
		"\7\22\2\2-=\b\2\1\2./\7\23\2\2/=\b\2\1\2\60\61\7\24\2\2\61=\b\2\1\2\62"+
		"\63\7\25\2\2\63=\b\2\1\2\64\65\7\26\2\2\65=\b\2\1\2\66\67\7\27\2\2\67"+
		"=\b\2\1\289\7\30\2\29=\b\2\1\2:;\7\31\2\2;=\b\2\1\2<\4\3\2\2\2<\7\3\2"+
		"\2\2<\n\3\2\2\2<\f\3\2\2\2<\16\3\2\2\2<\20\3\2\2\2<\22\3\2\2\2<\24\3\2"+
		"\2\2<\26\3\2\2\2<\30\3\2\2\2<\33\3\2\2\2<\36\3\2\2\2<!\3\2\2\2<$\3\2\2"+
		"\2<&\3\2\2\2<(\3\2\2\2<*\3\2\2\2<,\3\2\2\2<.\3\2\2\2<\60\3\2\2\2<\62\3"+
		"\2\2\2<\64\3\2\2\2<\66\3\2\2\2<8\3\2\2\2<:\3\2\2\2=@\3\2\2\2><\3\2\2\2"+
		">?\3\2\2\2?A\3\2\2\2@>\3\2\2\2AB\b\2\1\2B\3\3\2\2\2\4<>";
